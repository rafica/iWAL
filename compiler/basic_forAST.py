...
def p_statement_2(p):
    ...
    # p[0] = p[1]
    p[0] = ('compnd__stmt',p[1])

def p_statement_3(p):
    'statement : declaration_statement'
    # p[0] = p[1]
    p[0] = ('declrtn__stmt',p[1])

def p_statement_4(p):
    'statement : selection_statement'
    # p[0] = p[1]
    p[0] = ('selectn__stmt',p[1])
...
##    elif p[1].lower()=='int':
    ...
    # p[0] = p[1] + ' ' + p[2] + ' = ' + p[4] + ' ;'
    p[0] = ('assignexpn__declrtnstmt',p[2],p[1],p[4])
...
def p_compound_statement_2(p):
    ...
    # p[0] = '{ '+p[2]+' }'
    p[0] = ('nonempty__cmpndstmt',p[1])

# expression_statement:
def p_expression_statement_1(p):
    'expression_statement : expression SEMI'
    # p[0] = p[1] + ';'
    p[0] = ('expn__expnstmt',p[1])
...
def p_expression_1(p):
    ...
    # p[0] = p[1]
    p[0] = ('assignexpn__expn',p[1])

def p_expression_2(p):
    'expression : function_expression'
    # p[0] = p[1]
    p[0] = ('funcexpn__expn',p[1])

def p_expression_3(p):
    'expression : LPAREN expression RPAREN'
    # p[0] = '( ' + p[2] + ' )'
    p[0] = ('brckt_expn__expn',p[2])

# function_expression:
def p_function_expression_1(p):
    'function_expression : ID LPAREN parameter_list RPAREN' #SHOULDN'T THERE BE A SEMI-COLON HERE??
    global errorFlag
    global driverNumber
...
def p_return_statement_1(p):
    ...
    # p[0] = 'return ;'
    p[0] = ('empty__returnstmt','return')

def p_return_statement_2(p):
    'return_statement : RETURN expression SEMI'
    # p[0] = 'return ' + p[2] + ' ;'
    p[0] = ('nonempty__returnstmt','return',p[2])

# break_statement:
def p_break_statement_1(p):
    'break_statement : BREAK SEMI'
    # p[0] = 'break ;'
    p[0] = ('break__breakstmt','break')

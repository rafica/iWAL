...
def logical_AND_expression_2(s, temp, scope):
...
def primary_expression_1(s, temp, scope):
    temp.datatype = temp.children[0].datatype
    temp.code = '( ' + temp.children[0].code + ' )'


def primary_expression_2(s, temp, scope):
    temp.datatype = temp.children[0].datatype
    temp.code = temp.children[0].code
...
def primary_expression_4(s, temp, scope):
    temp.datatype = temp.children[0].datatype
    temp.code = temp.children[0].code


def primary_expression_5(s, temp, scope):
    temp.datatype = temp.children[0].datatype
    temp.code = temp.children[0].code


def multiplicative_expression_1(s, temp, scope):
    temp.datatype = temp.children[0].datatype
    temp.code = temp.children[0].code
